...
/** Handles fetching and saving {@link Ticket} instances. */
@WebServlet("/tickets")
public class TicketServlet extends HttpServlet {
  ...
  /**
   * Responds with a JSON representation of {@link Ticket} data for a specific user. Responds with
  ...
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    List<Ticket> tickets = tixDatastore.getTix(user);
    Gson gson = new Gson();
